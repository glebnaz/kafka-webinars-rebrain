...
type cfgApp struct {
	DebugPort string `json:"debug_port" envconfig:"DEBUG_PORT" default:":9084"`
	PortHTTP  string `json:"port_http" envconfig:"PORT_HTTP" default:":9080"`
	PortGRPC  string `json:"port_grpc" envconfig:"PORT_GRPC" default:":9082"`
}
...
func grpcServer(srv *services.TwitterService, grpcOPTS []grpc.ServerOption) *grpc.Server {
	...
	pb.RegisterTwitterServiceFeedServer(grpcServer, srv)
...
func httpServer(ctx context.Context, endpoint string) *runtime.ServeMux {
	...
	mustInit(pb.RegisterTwitterServiceFeedHandlerFromEndpoint(ctx, mux, endpoint, []grpc.DialOption{grpc.WithInsecure()}))
	return mux
}
